...
namespace tag_loader
{
	...
	public:
		...
		static datum tag_module_load(std::string tag_module_rel_path, int target_index = -1);
		...
		//returns datum of injected tag from tag_name (returns firstof if more than one tags share same name)
