...
CHECK_STRUCT_SIZE(s_saved_game_controller_settings_item, 64);
...
struct s_saved_game_controller_settings
{
	...
	uint32 flags;
	uint32 field_8;
	s_saved_game_controller_settings_item items[57];
};
CHECK_STRUCT_SIZE(s_saved_game_controller_settings, 3660);
...
CHECK_STRUCT_SIZE(s_saved_game_file_player_profile, 4616);
#pragma pack(pop)
