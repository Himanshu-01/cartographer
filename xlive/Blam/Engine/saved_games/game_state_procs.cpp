...
void __cdecl game_state_call_before_load_procs(int32 a1)
{
	INVOKE(0x8C245, 0, game_state_call_before_load_procs, a1);
	return;
}
...
void __cdecl game_state_call_after_load_procs(int32 a1)
{
