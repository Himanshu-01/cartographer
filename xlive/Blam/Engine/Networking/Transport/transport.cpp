...
bool __cdecl transport_address_populate_from_network_channel_and_compare(c_network_channel* network_channel, network_address* a1, const network_address* a2, bool check_network_port)
{
	bool equal = false;
