...

{
	...
	//c_user_interface_widget::c_user_interface_widget(this, _widget_type_screen, user_flags);
	...
	//c_normal_text_widget::c_normal_text_widget(&this->m_header_text, 0);
	//c_normal_text_widget::c_normal_text_widget(&this->m_screen_button_key_text, 0);
...
//void  __noreturn pre_initialize(int a1@<esi>)
//{
...
//void  __noreturn load_proc(int a1@<esi>)
//{
//	INVOKE_TYPE(0x288255, 0x0, void __usercall(__noreturn*)(int), a1@<esi>);
//}
