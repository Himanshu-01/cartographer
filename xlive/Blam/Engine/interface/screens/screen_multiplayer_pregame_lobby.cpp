...
{
	//_pregame_lobby_pane_0_text_0 = 0,
	...
	// 
	// Todo : add a helper function to convert tag_block_index to text_index 
	...
	_pregame_lobby_pane_0_text_48,
	_pregame_lobby_pane_0_text_map_download_progress,
	_pregame_lobby_pane_0_text_50,
	_pregame_lobby_pane_0_text_51,
	_pregame_lobby_pane_0_text_52,
	_pregame_lobby_pane_0_text_53,
...
const e_pregame_lobby_text_blocks c_screen_pregame_lobby_text_pane_1_mapping(const e_pregame_lobby_text_blocks pane_1)
{
	...
	case _pregame_lobby_pane_1_text_43:
		return _pregame_lobby_pane_0_text_48;
...
void c_screen_multiplayer_pregame_lobby::apply_patches()
{
	LOG_INFO_FUNC("applying code fixes");
	...
	//	fix chatbox using wrong _pregame_lobby_pane_1_text_active_protocol instead of chatbox 
	WriteValue<uint8>(Memory::GetAddress(0x2435AE) + 1, _pregame_lobby_pane_1_text_43 + 2);
}

void c_screen_multiplayer_pregame_lobby::apply_tag_patches()
{
	...
	cooperative_pane->bitmap_blocks[_pregame_lobby_pane_1_bitmap_name_field]->bitmap_tag.TagIndex = NONE;
	...
	cooperative_player_block->skin.TagIndex = custom_games_player_block->skin.TagIndex;
	...
	//	_pregame_lobby_pane_0_text_48 potential chat_box text
	cooperative_pane->text_blocks[_pregame_lobby_pane_1_text_43]->custom_font = custom_games_pane->text_blocks[_pregame_lobby_pane_0_text_48]->custom_font;
